...
export class InitDB1726551687048 implements MigrationInterface {
    name = 'InitDB1726551687048'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "token" character varying NOT NULL, "creator" character varying NOT NULL, "activated" boolean NOT NULL DEFAULT false, "completed" boolean NOT NULL DEFAULT false, "name" character varying NOT NULL, "symbol" character varying NOT NULL, "uri" character varying NOT NULL, "icon" character varying NOT NULL, "banner" character varying NOT NULL, "desc" character varying NOT NULL, "supplied" character varying NOT NULL, "reserve" character varying NOT NULL, "parsedSupplied" numeric NOT NULL, "parsedReserve" numeric NOT NULL, "link" text NOT NULL DEFAULT '{}', "timestamp" integer NOT NULL, "lastPrice" numeric, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`);
