...
export class InitDB1716733900693 implements MigrationInterface {
    name = 'InitDB1716733900693'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "token" character varying NOT NULL DEFAULT '', "name" character varying NOT NULL DEFAULT '', "symbol" character varying NOT NULL DEFAULT '', "decimals" integer NOT NULL DEFAULT '18', "description" character varying NOT NULL, "reserveToken" character varying NOT NULL DEFAULT '', "image" character varying NOT NULL, "twitterLink" character varying NOT NULL, "telegramLink" character varying NOT NULL, "website" character varying NOT NULL, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`);
